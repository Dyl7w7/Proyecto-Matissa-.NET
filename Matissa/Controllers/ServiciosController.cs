...
namespace Matissa.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ServiciosController(dbMatissaNETContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdServicio,NombreServicio,Descripción,Duración,Precio,Estado,IdTipoServicio")] Servicio servicio)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'dbMatissaNETContext.Servicios'  is null.");
            }
            var servicio = await _context.Servicios.FindAsync(id);
            if (servicio != null)
            {
